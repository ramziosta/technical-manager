    ...
    <>
      <div className={styles.footer}>
        ...
        <div className={styles.logo}>
         <a href="#hero" > <Image src={logo} alt="logo" width={60} height={100} /></a>
...
const TwitterXIcon = () => (
 <a href="https://twitter.com/OstaRamzi"> <svg
...
const LinkedIn = () => (
 <a href="https://www.linkedin.com/in/ramziosta/" ><svg
    className={styles.twitterXIcon}
    viewBox="0 0 448 512"
    height="2em"
    width="2em"
...
const Instagram = () => (
  <a href="https://www.instagram.com/ramziosta/" ><svg
    className={styles.twitterXIcon}
    viewBox="0 0 448 512"
    height="2em"
    width="2em"
...
const Github = () => (
  <a href="https://github.com/ramziosta" ><svg
